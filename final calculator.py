...
button_delete = Button(calculator, text="Delete", padx=21, pady=20, command=lambda: button_click(
    "Delete"), font=default, state=NORMAL, bg="green")
...
button_decimal = Button(calculator, text=".", command=lambda: button_click(
    "."), font=signs, state=DISABLED, bg="orange", padx=35, pady=13)
